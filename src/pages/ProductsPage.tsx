          ...
          <div className="mt-8 space-y-10">
            {grouped.map((group) => (
              <section key={group.category}>
                <h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-blue-400 mb-2">
                  {group.category}
                </h3>
                  ...
                  {group.items.map((product) => {
                    ...
                    >
                      ...
                      <div className="relative rounded-lg bg-slate-900/90 p-4 overflow-hidden">
                        {/* Category badge */}
                        <div className="absolute top-2 right-2 z-10 px-3 py-1 rounded-full bg-gradient-to-r from-purple-600 to-pink-600 text-xs font-bold text-white shadow-lg">
                          {group.category}
                        </div>
